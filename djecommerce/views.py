...
class OrderSummaryView(LoginRequiredMixin, View):
    def get(self, *args, **kwargs):
        try:
            ...
            return  redirect('djecommerce:order_summary')
...
class PaymentView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            messages.success(self.request, "Your ordered was successed")
            return redirect("/")
            ...
            # yourself an email
            messages.error(self.request, "Soemthing went wrong. Your are not charched, Please try again")
            return redirect("/")
...
def add_to_cart(request, slug):
    ...
    # because it is returning tuple to us
...
def remove_single_from_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        return redirect('djecommerce:order_summary', slug = slug)
...
def get_coupon(request, code):
    try:
        ...
        messages.info(request, "This coupon doesnt exists")
        return redirect('djecommerce:checkout')
        ...
        def post(self, *args, **kwargs):
            ...
            if form.is_valid():
                try:
                    ...
                    messages.info(self.request, "You don't have any active orders")
                    return redirect('djecommerce:checkout')
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            # refund the error
                ...
                refund.email = email
                refund.save()
                messages.info(self.request, "Your refund is successfully initiated")
